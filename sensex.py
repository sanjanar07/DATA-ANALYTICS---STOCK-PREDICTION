...
def filedownload(df):
    ...
    href = f'<a href="data:file/csv;base64,{b64}" download="SENSEX.csv">Download CSV File</a>'
    return href
...
def app():
  ...
  st.markdown("""
This app retrieves the list of the **SENSEX** (from Wikipedia) and its corresponding!
* **Python libraries:** base64, pandas, streamlit, numpy, matplotlib, seaborn
* **Data source:** [Wikipedia](https://en.wikipedia.org/wiki/BSE_SENSEX).
""")
